          ...
          <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <div className="mt-4 border-t border-blue-200 dark:border-blue-700 pt-4">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h5 className="text-sm font-medium text-gray-900 dark:text-white">Homework Settings</h5>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    Configure homework options for all materials
                  </p>
                </div>
                <label className="inline-flex items-center cursor-pointer">
                  ...
                  <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                    {globalSettings.isHomework ? 'Enabled' : 'Disabled'}
                  </span>
                </label>
              </div>

              {globalSettings.isHomework && (
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800 space-y-4 animate-in slide-in-from-top-2 duration-200">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                      Homework Type
