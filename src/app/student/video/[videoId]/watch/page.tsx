    ...
    <div 
      className={`min-h-screen p-6 ${
        theme === 'tinkerbell'
          ...
          ? ''
          : theme === 'bounceworld'
          ? 'bg-gradient-to-br from-[#1D428A] via-white to-[#C8102E]'
          : theme === 'avengers'
