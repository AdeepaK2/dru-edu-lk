...
export default function StudentTests() {
  ...
  if (!authLoading && !loading && (!enrollments || enrollments.length === 0)) {
    return (
      <StudentLayout>
        <div
          className={`min-h-screen p-6 ${theme === 'ben10' ? '' : theme === 'tinkerbell' ? 'bg-gradient-to-br from-yellow-300 via-green-400 to-yellow-400' : theme === 'cricketverse' ? 'bg-gradient-to-br from-blue-400 to-indigo-600' : theme === 'bounceworld' ? 'bg-gradient-to-br from-white via-[#1D428A] to-[#C8102E]' : theme === 'avengers' ? 'bg-gradient-to-br from-[#2C1267] to-[#4F2C8D]' : 'bg-gradient-to-br from-blue-400 to-indigo-600'}`}
          style={
            theme === 'ben10'
        ...
        >
        {/* Tests Header */}
        <div className={`bg-gradient-to-r rounded-3xl shadow-2xl border-4 ${theme === 'bounceworld' ? 'border-[#1D428A]' : 'border-black'} p-8 mb-6 relative overflow-hidden ${theme === 'ben10' ? 'from-[#64cc4f] via-black to-[#64cc4f]' : theme === 'tinkerbell' ? 'from-pink-500 via-pink-600 to-purple-700' : theme === 'cricketverse' ? 'from-blue-500 to-indigo-600' : theme === 'bounceworld' ? 'from-[#1D428A] via-white to-[#C8102E]' : theme === 'avengers' ? 'from-[#2C1267] via-[#604AC7] to-[#0F0826]' : 'from-blue-500 to-indigo-600'}`}>
          ...
          {/* No Tests Message */}
          <div className={`bg-gradient-to-r rounded-3xl shadow-2xl border-4 ${theme === 'bounceworld' ? 'border-[#C8102E]' : 'border-black'} p-12 text-center ${theme === 'ben10' ? 'from-[#b2e05b] via-black to-[#b2e05b]' : theme === 'tinkerbell' ? 'from-green-300 via-black to-green-300' : theme === 'bounceworld' ? 'from-white via-[#1D428A]/20 to-white border-[#1D428A]' : theme === 'avengers' ? 'from-[#604AC7]/30 via-[#2C1267]/30 to-[#0F0826]/30 border-[#2C1267]' : 'from-blue-300 via-indigo-500 to-blue-300'}`}>
            {(theme === 'ben10' || theme === 'tinkerbell') && <div className="text-8xl mb-6">📚</div>}
            <h2 className="text-3xl font-black text-white mb-4">
              No Tests Yet
            </h2>
            <p className="text-white font-bold text-lg mb-6">
              You haven't enrolled in any classes yet. Contact your teacher to start taking tests! {theme === 'ben10' ? '🎓⚡' : theme === 'tinkerbell' ? '🎓⚡' : theme === 'avengers' ? '🦸‍♂️' : ''}
            </p>
            <Button
              onClick={() => router.push('/student/dashboard')}
              className={`text-white px-8 py-3 rounded-full font-black text-lg transform hover:scale-105 transition-all shadow-lg border-4 ${theme === 'bounceworld' ? 'border-[#1D428A]' : 'border-black'} flex items-center space-x-3 ${theme === 'ben10' ? 'bg-gradient-to-r from-[#64cc4f] to-[#222222] hover:from-[#b2e05b] hover:to-[#222222]' : theme === 'tinkerbell' ? 'bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700' : theme === 'bounceworld' ? 'bg-gradient-to-r from-[#1D428A] to-[#C8102E] hover:from-[#C8102E] hover:to-[#1D428A]' : theme === 'avengers' ? 'bg-gradient-to-r from-[#604AC7] to-[#2C1267] hover:from-[#2C1267] hover:to-[#0F0826]' : 'bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700'}`}
            >
  ...
  if (authLoading || loading) {
    return (
      <StudentLayout>
        <div
          className={`min-h-screen p-6 flex items-center justify-center ${theme === 'ben10' ? 'bg-gradient-to-br from-[#64cc4f] to-[#222222]' : theme === 'tinkerbell' ? 'bg-gradient-to-br from-yellow-300 via-green-400 to-yellow-400' : theme === 'bounceworld' ? 'bg-gradient-to-br from-white via-[#1D428A]/10 to-[#C8102E]/10' : theme === 'avengers' ? 'bg-gradient-to-br from-[#604AC7] via-[#2C1267] to-[#0F0826]' : 'bg-gradient-to-br from-blue-400 to-indigo-600'}`}
          
        >
          <div className={`bg-white border-4 ${theme === 'bounceworld' ? 'border-[#C8102E]' : 'border-black'} rounded-3xl p-8 shadow-2xl`}>
  ...
  return (
    <StudentLayout>
      <div
        className={`min-h-screen p-6 ${theme === 'ben10' ? '' : theme === 'tinkerbell' ? 'bg-gradient-to-br from-yellow-300 via-green-400 to-yellow-300' : theme === 'bounceworld' ? 'bg-gradient-to-br from-white via-[#1D428A]/10 to-[#C8102E]/10' : theme === 'avengers' ? 'bg-gradient-to-br from-[#604AC7]/20 via-[#2C1267]/20 to-[#0F0826]/20' : 'bg-gradient-to-br from-blue-400 via-indigo-500 to-blue-400'}`}
        style={
          theme === 'ben10'
            ? { background: 'linear-gradient(to bottom right, rgb(100, 204, 79), rgb(178, 224, 91), rgb(34, 34, 34))' }
            : undefined
      ...
      >
        {/* Tests Header */}
        <div className={`rounded-3xl shadow-2xl border-4 ${theme === 'bounceworld' ? 'border-[#1D428A]' : 'border-black'} p-8 mb-6 relative overflow-hidden ${theme === 'ben10' ? 'bg-gradient-to-br from-[#64cc4f] to-[#222222]' : theme === 'tinkerbell' ? 'bg-gradient-to-r from-yellow-500 via-green-500 to-yellow-500' : theme === 'bounceworld' ? 'bg-gradient-to-r from-[#1D428A] via-white to-[#C8102E]' : theme === 'avengers' ? 'bg-gradient-to-r from-[#604AC7] via-[#2C1267] to-[#0F0826]' : 'bg-gradient-to-r from-blue-500 via-indigo-600 to-blue-500'}`}>
         ...
         <div className="flex items-center justify-between relative z-10">
            ...
            <div className={`bg-white border-4 ${theme === 'bounceworld' ? 'border-[#1D428A]' : 'border-black'} rounded-2xl p-4 shadow-lg`}>
        ...
        {/* Error Display */}
        {error && (
          <div className={`rounded-xl border-4 ${theme === 'bounceworld' ? 'border-[#C8102E]' : 'border-black'} p-4 shadow-lg ${theme === 'ben10' ? 'bg-gradient-to-r from-red-400 to-red-600' : theme === 'tinkerbell' ? 'bg-gradient-to-r from-red-300 to-pink-300' : 'bg-gradient-to-r from-red-400 to-red-500'}`}>
            <div className="flex items-center space-x-3">
        ...
        {/* Search Controls */}
        <div className={`rounded-2xl shadow-xl border-4 ${theme === 'bounceworld' ? 'border-[#C8102E]' : 'border-black'} p-6 mb-6 ${theme === 'ben10' ? 'bg-gradient-to-br from-[#64cc4f] to-[#222222]' : theme === 'tinkerbell' ? 'bg-gradient-to-r from-yellow-300 via-green-400 to-yellow-300' : theme === 'bounceworld' ? 'bg-gradient-to-r from-white via-[#1D428A]/20 to-white border-[#1D428A]' : theme === 'avengers' ? 'bg-gradient-to-r from-[#604AC7]/20 via-[#2C1267]/20 to-[#0F0826]/20 border-[#2C1267]' : 'bg-gradient-to-r from-blue-300 via-indigo-400 to-blue-300'}`}>
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-12 pr-4 py-3 text-lg border-4 ${theme === 'bounceworld' ? 'border-[#C8102E]' : 'border-black'} rounded-2xl bg-white text-black placeholder-gray-500 focus:outline-none shadow-lg ${theme === 'ben10' ? 'focus:ring-4 focus:ring-[#64cc4f]' : theme === 'tinkerbell' ? 'focus:ring-4 focus:ring-yellow-400' : theme === 'bounceworld' ? 'focus:ring-4 focus:ring-[#C8102E]' : theme === 'avengers' ? 'focus:ring-4 focus:ring-[#604AC7]' : 'focus:ring-4 focus:ring-blue-400'}`}
                />
              </div>
            </div>
            ...
            <div className="flex-shrink-0 min-w-[200px]">
              <select
                ...
                className={`border-4 ${theme === 'bounceworld' ? 'border-[#1D428A]' : 'border-black'} rounded-2xl px-6 py-3 bg-white text-black font-bold text-lg focus:outline-none shadow-lg hover:bg-gray-50 transition-all w-full ${theme === 'ben10' ? 'focus:ring-4 focus:ring-[#64cc4f]' : theme === 'tinkerbell' ? 'focus:ring-4 focus:ring-yellow-400' : theme === 'bounceworld' ? 'focus:ring-4 focus:ring-[#1D428A]' : theme === 'avengers' ? 'focus:ring-4 focus:ring-[#604AC7]' : 'focus:ring-4 focus:ring-blue-400'}`}
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-6">
            <div className={`bg-white border-4 ${theme === 'bounceworld' ? 'border-[#1D428A]' : 'border-black'} rounded-2xl p-6 text-center shadow-lg hover:scale-105 transition-all`}>
            ...
            <div className={`bg-white border-4 ${theme === 'bounceworld' ? 'border-[#C8102E]' : 'border-black'} rounded-2xl p-6 text-center shadow-lg hover:scale-105 transition-all`}>
              {(theme === 'ben10' || theme === 'tinkerbell') && <div className="text-4xl mb-2">🎯</div>}
              <div className="text-3xl font-black text-black mb-1">
        ...
        {customTests.length > 0 && (
          <div className={`rounded-3xl shadow-2xl border-4 ${theme === 'bounceworld' ? 'border-[#1D428A]' : 'border-black'} overflow-hidden ${theme === 'ben10' ? 'bg-gradient-to-r from-[#64cc4f] via-black to-[#64cc4f]' : theme === 'tinkerbell' ? 'bg-gradient-to-r from-yellow-300 via-green-400 to-yellow-300' : theme === 'bounceworld' ? 'bg-gradient-to-r from-white via-[#1D428A]/20 to-white border-[#1D428A]' : theme === 'avengers' ? 'bg-gradient-to-r from-[#604AC7]/20 via-[#2C1267]/20 to-[#0F0826]/20 border-[#2C1267]' : 'bg-gradient-to-r from-blue-300 via-indigo-400 to-blue-300'}`}>
            {/* Custom Tests Header */}
            <div
              className={`p-6 border-b-4 border-black cursor-pointer transition-all ${theme === 'ben10' ? 'bg-[#b2e05b] hover:bg-[#b2e05b]' : theme === 'tinkerbell' ? 'bg-yellow-200 hover:bg-yellow-200' : theme === 'bounceworld' ? 'bg-white hover:bg-gray-50 border-[#1D428A]' : theme === 'avengers' ? 'bg-[#604AC7]/30 hover:bg-[#604AC7]/40' : 'bg-blue-200 hover:bg-blue-200'}`}
              ...
              <div className="flex items-center justify-between">
                  ...
                  <div>
                    <h2 className="text-2xl font-black text-black flex items-center">
                      ...
                      {(groupedCustomTests.live.length > 0 || groupedCustomTests.upcoming.length > 0 || groupedCustomTests.available.length > 0) && (
                        <span className={`ml-3 inline-flex items-center px-3 py-1 rounded-full text-sm font-black text-black border-2 border-black ${theme === 'ben10' ? 'bg-[#64cc4f]' : theme === 'tinkerbell' ? 'bg-yellow-400' : theme === 'bounceworld' ? 'bg-[#C8102E]' : theme === 'avengers' ? 'bg-[#C88DA5]' : 'bg-blue-400'}`}>
                          New!
                        </span>
                      )}
                    </h2>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  {groupedCustomTests.live.length > 0 && (
                    <span className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-black text-white border-2 border-black ${theme === 'ben10' ? 'bg-[#64cc4f]' : theme === 'tinkerbell' ? 'bg-yellow-500' : theme === 'bounceworld' ? 'bg-[#C8102E]' : theme === 'avengers' ? 'bg-[#604AC7]' : 'bg-blue-500'}`}>
                  ...
                  <span className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-black text-white border-2 border-black ${theme === 'ben10' ? 'bg-[#b2e05b]' : theme === 'tinkerbell' ? 'bg-yellow-600' : theme === 'bounceworld' ? 'bg-[#1D428A]' : theme === 'avengers' ? 'bg-[#0F0826]' : 'bg-blue-600'}`}>
                ...
                {groupedCustomTests.live.length > 0 && (
                  <>
                    ...
                    {groupedCustomTests.live.map((test) => {
                      ...
                      return (
                        <div key={test.id} className={`p-6 transition-all border-b-2 border-black last:border-b-0 ${theme === 'ben10' ? 'hover:bg-[#b2e05b]/20' : theme === 'tinkerbell' ? 'hover:bg-pink-200/20' : theme === 'bounceworld' ? 'hover:bg-[#1D428A]/10' : theme === 'avengers' ? 'hover:bg-[#604AC7]/10' : 'hover:bg-blue-200/20'}`}>
                ...
                {groupedCustomTests.upcoming.length > 0 && (
                  <>
                    ...
                    {groupedCustomTests.upcoming.map((test) => {
                      ...
                      return (
                        <div key={test.id} className={`p-6 transition-all border-b-2 border-black last:border-b-0 ${theme === 'ben10' ? 'hover:bg-[#b2e05b]/20' : theme === 'tinkerbell' ? 'hover:bg-pink-200/20' : theme === 'avengers' ? 'hover:bg-[#604AC7]/10' : 'hover:bg-blue-200/20'}`}>
                          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div>
                              <div className="flex items-center space-x-3">
                                {(theme === 'ben10' || theme === 'tinkerbell') && <div className="text-3xl">📅</div>}
            ...
            {/* Available Custom Tests */}
                ...
                {groupedCustomTests.completed.length > 0 && (
                  <>
                    <div className={`px-6 py-4 border-b-4 border-black ${theme === 'ben10' ? 'bg-gradient-to-r from-[#b2e05b] to-[#64cc4f]' : theme === 'tinkerbell' ? 'bg-gradient-to-r from-yellow-300 to-pink-300' : theme === 'avengers' ? 'bg-gradient-to-r from-[#C88DA5]/30 to-[#604AC7]/30' : 'bg-gradient-to-r from-blue-300 to-indigo-300'}`}>
                      <div className="flex items-center">
                        {(theme === 'ben10' || theme === 'tinkerbell') && <div className="text-2xl mr-3">✅</div>}
                        <span className="text-lg font-black text-black">
                    ...
                    {groupedCustomTests.completed.map((test) => {
                      ...
                      return (
                        <div key={test.id} className={`p-6 transition-all border-b-2 border-black last:border-b-0 ${theme === 'ben10' ? 'hover:bg-[#b2e05b]/20' : theme === 'tinkerbell' ? 'hover:bg-pink-200/20' : theme === 'avengers' ? 'hover:bg-[#C88DA5]/10' : 'hover:bg-blue-200/20'}`}>
                          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div>
                              <div className="flex items-center space-x-3">
                                {(theme === 'ben10' || theme === 'tinkerbell') && <div className="text-3xl">📝</div>}
        ...
        {Object.entries(testsByClass).map(([classId, classData]) => {
          ...
          return (
            <div key={classId} className={`rounded-3xl shadow-2xl border-4 border-black overflow-hidden ${theme === 'ben10' ? 'bg-gradient-to-r from-[#64cc4f] via-black to-[#64cc4f]' : theme === 'tinkerbell' ? 'bg-gradient-to-r from-yellow-300 via-black to-yellow-300' : theme === 'bounceworld' ? 'bg-gradient-to-r from-white via-[#1D428A]/20 to-white border-[#1D428A]' : theme === 'avengers' ? 'bg-gradient-to-r from-[#604AC7] via-[#2C1267] to-[#0F0826]' : 'bg-gradient-to-r from-blue-300 via-black to-blue-300'}`}>
              {/* Class Header */}
              <div
                className={`p-6 border-b-4 border-black cursor-pointer transition-all ${theme === 'ben10' ? 'bg-[#b2e05b] hover:bg-[#b2e05b]' : theme === 'tinkerbell' ? 'bg-yellow-200 hover:bg-yellow-200' : theme === 'bounceworld' ? 'bg-white hover:bg-gray-50 border-[#1D428A]' : theme === 'avengers' ? 'bg-[#604AC7]/30 hover:bg-[#604AC7]/40' : 'bg-blue-200 hover:bg-blue-200'}`}
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    {/* Test count badges */}
                    {liveCount > 0 && (
                      <span className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-black text-white border-2 border-black ${theme === 'ben10' ? 'bg-[#64cc4f]' : theme === 'tinkerbell' ? 'bg-green-500' : theme === 'bounceworld' ? 'bg-[#C8102E]' : theme === 'avengers' ? 'bg-[#604AC7]' : 'bg-blue-500'}`}>
                        {liveCount} Live Now
                      </span>
                    )}
                    {upcomingCount > 0 && (
                      <span className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-black text-white border-2 border-black ${theme === 'ben10' ? 'bg-purple-500' : theme === 'tinkerbell' ? 'bg-purple-500' : theme === 'bounceworld' ? 'bg-purple-500' : theme === 'avengers' ? 'bg-[#C88DA5]' : 'bg-purple-500'}`}>
                        {upcomingCount} Upcoming
                      </span>
                    )}
                    {availableCount > 0 && (
                      <span className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-black text-white border-2 border-black ${theme === 'ben10' ? 'bg-blue-500' : theme === 'tinkerbell' ? 'bg-blue-500' : theme === 'bounceworld' ? 'bg-blue-500' : theme === 'avengers' ? 'bg-[#604AC7]' : 'bg-blue-500'}`}>
                        {availableCount} Available
                      </span>
                    )}
                    <span className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-black text-white border-2 border-black ${theme === 'ben10' ? 'bg-[#b2e05b]' : theme === 'tinkerbell' ? 'bg-yellow-600' : theme === 'bounceworld' ? 'bg-[#1D428A]' : theme === 'avengers' ? 'bg-[#0F0826]' : 'bg-indigo-600'}`}>
                  ...
                  {!hasTests ? (
                    ...
                    <>
                      ...
                      {classData.groupedTests.live.length > 0 && (
                        <>
                          <div className={`px-6 py-4 border-b-4 border-black ${theme === 'ben10' ? 'bg-gradient-to-r from-[#b2e05b] to-[#64cc4f]' : theme === 'bounceworld' ? 'bg-gradient-to-r from-[#1D428A]/10 to-[#C8102E]/10' : theme === 'avengers' ? 'bg-gradient-to-r from-[#604AC7]/30 via-[#2C1267]/30 to-[#0F0826]/30' : 'bg-gradient-to-r from-green-300 to-yellow-300'}`}>
                            <div className="flex items-center">
                              <div className="text-2xl mr-3">🎯</div>
                              <span className="text-lg font-black text-black">
                      ...
                      {classData.groupedTests.available.length > 0 && (
                        <>
                          <div className={`px-6 py-4 border-b-4 border-black ${theme === 'ben10' ? 'bg-gradient-to-r from-[#b2e05b] to-[#64cc4f]' : theme === 'tinkerbell' ? 'bg-gradient-to-r from-yellow-300 to-green-300' : theme === 'bounceworld' ? 'bg-gradient-to-r from-[#1D428A]/10 to-[#C8102E]/10' : 'bg-gradient-to-r from-blue-300 to-cyan-300'}`}>
                            <div className="flex items-center">
                          ...
                          {classData.groupedTests.available.map((test) => {
                            ...
                            return (
                              <div key={test.id} className={`p-6 transition-all border-b-2 border-black last:border-b-0 ${theme === 'ben10' ? 'hover:bg-[#b2e05b]/20' : theme === 'tinkerbell' ? 'hover:bg-pink-200/20' : theme === 'bounceworld' ? 'hover:bg-[#1D428A]/10' : 'hover:bg-blue-200/20'}`}>
                                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                                  <div className="mb-4 md:mb-0">
                                    <div className="flex items-center space-x-3">
                                      {(theme === 'ben10' || theme === 'tinkerbell') && <div className="text-3xl">📝</div>}
                      ...
                      {classData.groupedTests.completed.length > 0 && (
                        <>
                          <div className={`px-6 py-4 border-b-4 border-black ${theme === 'ben10' ? 'bg-gradient-to-r from-[#b2e05b] to-[#64cc4f]' : theme === 'tinkerbell' ? 'bg-gradient-to-r from-yellow-300 to-green-300' : theme === 'bounceworld' ? 'bg-gradient-to-r from-[#1D428A]/10 to-[#C8102E]/10' : theme === 'avengers' ? 'bg-gradient-to-r from-[#C88DA5]/30 to-[#604AC7]/30' : 'bg-gradient-to-r from-blue-300 to-indigo-300'}`}>
                            <div className="flex items-center justify-between">
                              <div className="flex items-center">
                                {(theme === 'ben10' || theme === 'tinkerbell') && <div className="text-2xl mr-3">✅</div>}
                                <span className="text-lg font-black text-black">
                          ...
                          {(expandedCompletedSections.has(classId) 
                            ...
                            return (
                              <div key={test.id} className={`p-6 transition-all border-b-2 border-black last:border-b-0 ${theme === 'ben10' ? 'hover:bg-[#b2e05b]/20' : theme === 'tinkerbell' ? 'hover:bg-yellow-200/20' : theme === 'bounceworld' ? 'hover:bg-[#1D428A]/10' : theme === 'avengers' ? 'hover:bg-[#C88DA5]/10' : 'hover:bg-blue-200/20'}`}>
                                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                                  <div>
                                    <div className="flex items-center space-x-3">
