...
export default function StudentClassesPage() {
  ...
  if (authLoading || loading) {
    return (
      <div className={`min-h-screen ${theme === 'default' ? 'bg-gradient-to-br from-gray-50 to-gray-100' : theme === 'ben10' ? 'bg-gradient-to-br from-[#64cc4f] to-[#222222]' : theme === 'tinkerbell' ? 'bg-gradient-to-br from-yellow-300 via-green-400 to-yellow-400' : theme === 'cricketverse' ? 'bg-gradient-to-br from-blue-400 to-indigo-600' : theme === 'bounceworld' ? 'bg-gradient-to-br from-white via-[#1D428A] to-[#C8102E]' : theme === 'avengers' ? 'bg-gradient-to-br from-[#2C1267] via-[#604AC7] to-[#0F0826]' : theme === 'ponyville' ? 'bg-gradient-to-br from-[#fff5fb] via-[#f1aed5] to-[#ff2e9f]' : 'bg-gradient-to-br from-blue-400 to-indigo-600'} flex items-center justify-center`}>
  ...
  return (
    <>
      <div
        className={`min-h-screen p-6 ${theme === 'default' ? 'bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50' : theme === 'ben10' ? '' : theme === 'tinkerbell' ? 'bg-gradient-to-br from-yellow-300 via-green-400 to-yellow-400' : theme === 'cricketverse' ? 'bg-gradient-to-br from-blue-400 via-indigo-500 to-indigo-600' : theme === 'bounceworld' ? 'bg-gradient-to-br from-white via-[#1D428A]/10 to-white' : theme === 'avengers' ? 'bg-gradient-to-br from-[#2C1267]/10 via-[#604AC7]/10 to-[#0F0826]/10' : theme === 'ponyville' ? 'bg-gradient-to-br from-[#fff5fb] via-[#f1aed5] to-[#ff2e9f]' : 'bg-gradient-to-br from-blue-400 via-indigo-500 to-indigo-600'}`}
        style={
          theme === 'ben10'
      ...
      >
          ...
          <div className="flex items-center justify-between relative z-10">
            ...
            {theme === 'cricketverse' ? (
              ...
              <div>
                ...
                <p className={`font-bold text-lg ${theme === 'default' ? 'text-black' : theme === 'ben10' ? 'text-white' : theme === 'tinkerbell' ? 'text-white' : theme === 'cricketverse' ? 'text-blue-100' : theme === 'bounceworld' ? 'text-[#1D428A]' : theme === 'avengers' ? 'text-white' : theme === 'ponyville' ? 'text-white' : 'text-blue-100'}`}>
        ...
        <div className={`${theme === 'default' ? 'bg-white' : 'bg-gradient-to-r'} ${theme === 'default' ? '' : theme === 'ben10' ? 'from-[#64cc4f] to-[#222222]' : theme === 'tinkerbell' ? 'from-green-300 via-green-400 to-yellow-400' : theme === 'cricketverse' ? 'from-blue-300 via-indigo-400 to-indigo-500' : theme === 'bounceworld' ? 'from-white via-[#1D428A]/20 to-white border-[#1D428A]' : theme === 'avengers' ? 'from-[#604AC7]/20 via-[#2C1267]/20 to-[#0F0826]/20 border-[#2C1267]' : theme === 'ponyville' ? 'from-[#f1aed5]/20 via-[#e13690]/20 to-[#ff2e9f]/20 border-[#f1aed5]' : 'from-blue-300 via-indigo-400 to-indigo-500'} rounded-2xl shadow-xl border-4 ${theme === 'bounceworld' ? 'border-[#1D428A]' : 'border-black'} p-6 mb-6`}>
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-12 pr-4 py-3 text-lg border-4 border-black rounded-2xl bg-white text-black placeholder-gray-500 focus:outline-none shadow-lg ${theme === 'default' ? 'focus:ring-4 focus:ring-blue-600' : theme === 'ben10' ? 'focus:ring-4 focus:ring-[#64cc4f]' : theme === 'tinkerbell' ? 'focus:ring-4 focus:ring-yellow-400' : theme === 'cricketverse' ? 'focus:ring-4 focus:ring-blue-400' : theme === 'bounceworld' ? 'focus:ring-4 focus:ring-[#1D428A]' : theme === 'avengers' ? 'focus:ring-4 focus:ring-[#604AC7]' : theme === 'ponyville' ? 'focus:ring-4 focus:ring-[#e13690]' : 'focus:ring-4 focus:ring-blue-400'}`}
                />
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <select
                ...
                className={`border-4 border-black rounded-2xl px-6 py-3 bg-white text-black font-bold text-lg focus:outline-none shadow-lg hover:bg-gray-50 transition-all ${theme === 'default' ? 'focus:ring-4 focus:ring-blue-600' : theme === 'ben10' ? 'focus:ring-4 focus:ring-[#64cc4f]' : theme === 'tinkerbell' ? 'focus:ring-4 focus:ring-yellow-400' : theme === 'cricketverse' ? 'focus:ring-4 focus:ring-blue-400' : theme === 'bounceworld' ? 'focus:ring-4 focus:ring-[#1D428A]' : theme === 'avengers' ? 'focus:ring-4 focus:ring-[#604AC7]' : theme === 'ponyville' ? 'focus:ring-4 focus:ring-[#e13690]' : 'focus:ring-4 focus:ring-blue-400'}`}
              >
        ...
        {filteredEnrollments.length === 0 ? (
          <div className={`${theme === 'default' ? 'bg-white' : 'bg-gradient-to-r'} ${theme === 'default' ? '' : theme === 'ben10' ? 'from-[#b2e05b] via-[#222222] to-[#64cc4f]' : theme === 'tinkerbell' ? 'from-yellow-200 via-green-400 to-yellow-300' : theme === 'cricketverse' ? 'from-blue-300 via-indigo-400 to-blue-400' : theme === 'bounceworld' ? 'from-white via-[#1D428A]/20 to-white border-[#1D428A]' : theme === 'avengers' ? 'from-[#604AC7]/30 via-[#2C1267]/30 to-[#0F0826]/30 border-[#2C1267]' : theme === 'ponyville' ? 'from-[#f1aed5]/30 via-[#e13690]/30 to-[#ff2e9f]/30 border-[#f1aed5]' : 'from-blue-300 via-indigo-400 to-blue-400'} rounded-3xl shadow-2xl border-4 border-black p-12`}>
            <div className="text-center">
              <div className="text-8xl mb-6">📚</div>
              <h3 className={`text-3xl font-black mb-4 ${theme === 'default' ? 'text-black' : 'text-white'}`}>
                {searchTerm || statusFilter !== 'all' ? 'No Classes Found' : 'No Classes Yet'}
              </h3>
              <p className={`font-bold text-lg mb-6 ${theme === 'default' ? 'text-gray-600' : theme === 'ben10' ? 'text-[#b2e05b]' : theme === 'tinkerbell' ? 'text-yellow-100' : theme === 'cricketverse' ? 'text-blue-100' : theme === 'bounceworld' ? 'text-[#1D428A]' : theme === 'avengers' ? 'text-white' : theme === 'ponyville' ? 'text-[#e13690]' : 'text-blue-100'}`}>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {filteredEnrollments.map((enrollment) => (
              <div
                key={enrollment.id}
                className={`rounded-3xl shadow-2xl border-4 border-black p-6 hover:shadow-3xl hover:scale-105 transition-all duration-300 hover:rotate-1 ${theme === 'default' ? 'bg-white' : theme === 'ben10' ? 'bg-gradient-to-br from-[#b2e05b] via-[#222222] to-[#64cc4f]' : theme === 'tinkerbell' ? 'bg-gradient-to-br from-yellow-200 via-green-400 to-yellow-300' : theme === 'cricketverse' ? 'bg-gradient-to-br from-blue-300 via-indigo-400 to-blue-400' : theme === 'bounceworld' ? 'bg-gradient-to-br from-white via-[#1D428A]/20 to-white' : theme === 'avengers' ? 'bg-gradient-to-br from-[#604AC7] via-[#2C1267] to-[#0F0826]' : theme === 'ponyville' ? 'bg-gradient-to-br from-[#f1aed5] via-[#e13690] to-[#ff2e9f]' : 'bg-gradient-to-br from-blue-300 via-indigo-400 to-blue-400'}`}
              >
                {/* Class Header */}
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-center space-x-4">
                    <div className={`w-16 h-16 rounded-full flex items-center justify-center border-4 border-black shadow-lg  ${theme === 'default' ? 'bg-blue-600' : theme === 'ben10' ? 'bg-[#64cc4f]' : theme === 'tinkerbell' ? 'bg-yellow-500' : theme === 'cricketverse' ? 'bg-blue-500' : theme === 'bounceworld' ? 'bg-[#1D428A]' : theme === 'avengers' ? 'bg-[#604AC7]' : theme === 'ponyville' ? 'bg-[#f1aed5]' : 'bg-blue-500'}`}>
                      <div className="text-3xl">📚</div>
                    </div>
                    <div>
                      ...
                      <p className={`text-black font-bold text-sm rounded-full px-3 py-1 border-2 border-black ${theme === 'default' ? 'bg-blue-100' : theme === 'ben10' ? 'bg-[#b2e05b]' : theme === 'tinkerbell' ? 'bg-yellow-200' : theme === 'cricketverse' ? 'bg-blue-200' : theme === 'bounceworld' ? 'bg-[#C8102E]/20' : theme === 'avengers' ? 'bg-[#604AC7]/30' : theme === 'ponyville' ? 'bg-[#e13690]/20' : 'bg-blue-200'}`}>
                        {enrollment.subject}
                      </p>
                    </div>
                  </div>
                  <span className={`px-4 py-2 text-sm font-black rounded-full border-4 border-black shadow-lg ${
                    enrollment.status === 'Active'
                      ? `${theme === 'default' ? 'bg-blue-600 text-white' : theme === 'ben10' ? 'bg-[#64cc4f] text-black' : theme === 'tinkerbell' ? 'bg-yellow-400 text-black' : theme === 'cricketverse' ? 'bg-blue-400 text-black' : theme === 'bounceworld' ? 'bg-[#1D428A] text-white' : theme === 'avengers' ? 'bg-[#604AC7] text-white' : theme === 'ponyville' ? 'bg-[#f1aed5] text-black' : 'bg-blue-400 text-black'}`
                      : enrollment.status === 'Completed'
                      ? `${theme === 'default' ? 'bg-green-600 text-white' : theme === 'ben10' ? 'bg-[#222222] text-[#64cc4f]' : theme === 'tinkerbell' ? 'bg-black text-yellow-400' : theme === 'cricketverse' ? 'bg-black text-blue-400' : theme === 'bounceworld' ? 'bg-[#C8102E] text-white' : theme === 'avengers' ? 'bg-[#0F0826] text-[#604AC7]' : theme === 'ponyville' ? 'bg-[#ff2e9f] text-white' : 'bg-black text-blue-400'}`
                      : enrollment.status === 'Inactive'
                      ? `${theme === 'default' ? 'bg-gray-500 text-white' : theme === 'ben10' ? 'bg-[#b2e05b] text-black' : theme === 'tinkerbell' ? 'bg-yellow-500 text-black' : theme === 'cricketverse' ? 'bg-blue-500 text-black' : theme === 'bounceworld' ? 'bg-[#1D428A]/50 text-white' : theme === 'avengers' ? 'bg-[#604AC7]/50 text-white' : theme === 'ponyville' ? 'bg-[#e13690]/50 text-white' : 'bg-blue-500 text-black'}`
                ...
                <div className="bg-white border-4 border-black rounded-2xl p-4 mb-4 shadow-lg">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className={`text-sm font-black rounded-full px-3 py-1 border-2 text-black border-black ${theme === 'default' ? 'bg-blue-100' : theme === 'ben10' ? 'bg-[#b2e05b]' : theme === 'tinkerbell' ? 'bg-yellow-200' : theme === 'cricketverse' ? 'bg-blue-200' : theme === 'bounceworld' ? 'bg-[#1D428A]/20' : theme === 'avengers' ? 'bg-[#604AC7]/30' : theme === 'ponyville' ? 'bg-[#e13690]/20' : 'bg-blue-200'}`}>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`text-lg font-black px-3 py-1 rounded-full border-2 border-black ${
                        enrollment.grade >= 80
                          ? `${theme === 'default' ? 'bg-blue-600 text-white' : theme === 'ben10' ? 'bg-[#64cc4f] text-black' : theme === 'tinkerbell' ? 'bg-yellow-400 text-black' : theme === 'cricketverse' ? 'bg-blue-400 text-black' : theme === 'bounceworld' ? 'bg-[#1D428A] text-white' : theme === 'avengers' ? 'bg-[#604AC7] text-white' : theme === 'ponyville' ? 'bg-[#f1aed5] text-black' : 'bg-blue-400 text-black'}`
                          : enrollment.grade >= 60
                          ? `${theme === 'default' ? 'bg-blue-500 text-white' : theme === 'ben10' ? 'bg-[#b2e05b] text-black' : theme === 'tinkerbell' ? 'bg-yellow-500 text-black' : theme === 'cricketverse' ? 'bg-blue-500 text-black' : theme === 'bounceworld' ? 'bg-[#C8102E] text-white' : theme === 'avengers' ? 'bg-[#C88DA5] text-white' : theme === 'ponyville' ? 'bg-[#e13690] text-white' : 'bg-blue-500 text-black'}`
                          : 'bg-red-400 text-black'
                      }`}>
                        {enrollment.grade}%
                      </span>
                ...
                {enrollment.notes && (
                  <div className="border-t-4 border-black pt-4 mb-4">
                    <div className="bg-white border-4 border-black rounded-2xl p-4 shadow-lg">
                      ...
                      <p className={`text-black font-medium rounded-lg p-3 border-2 border-black ${theme === 'default' ? 'bg-gray-100' : theme === 'ben10' ? 'bg-[#b2e05b]' : theme === 'tinkerbell' ? 'bg-yellow-100' : theme === 'cricketverse' ? 'bg-blue-100' : theme === 'bounceworld' ? 'bg-[#1D428A]/10' : theme === 'avengers' ? 'bg-[#604AC7]/20' : theme === 'ponyville' ? 'bg-[#f1aed5]/20' : 'bg-blue-100'}`}>
                        {enrollment.notes}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="border-t-4 border-black pt-4 mb-4">
                    <div className="bg-white border-4 border-black rounded-2xl p-4 shadow-lg">
                      <div className="mb-4">
                        ...
                        <div className={`p-3 rounded-xl border-2 border-black ${theme === 'default' ? 'bg-gray-100' : theme === 'ben10' ? 'bg-gradient-to-r from-[#b2e05b] to-[#222222]' : theme === 'tinkerbell' ? 'bg-gradient-to-r from-yellow-200 to-pink-200' : theme === 'cricketverse' ? 'bg-gradient-to-r from-blue-200 to-indigo-300' : theme === 'bounceworld' ? 'bg-gradient-to-r from-[#1D428A]/10 to-[#C8102E]/10' : theme === 'avengers' ? 'bg-gradient-to-r from-[#604AC7]/30 to-[#C88DA5]/20' : theme === 'ponyville' ? 'bg-gradient-to-r from-[#f1aed5]/30 to-[#e13690]/20' : 'bg-gradient-to-r from-blue-200 to-indigo-300'}`}>
                          <p className={`font-medium break-all text-sm ${theme === 'default' ? 'text-gray-700' : theme === 'ben10' ? 'text-white' : theme === 'tinkerbell' ? 'text-gray-800' : theme === 'cricketverse' ? 'text-gray-700' : theme === 'bounceworld' ? 'text-[#1D428A]' : theme === 'avengers' ? 'text-gray-700' : theme === 'ponyville' ? 'text-[#e13690]' : 'text-gray-700'}`}>
                            {enrollment.classData.zoomLink}
                          </p>
                        </div>
                      </div>
        ...
        {/* Summary Stats */}
        {filteredEnrollments.length > 0 && (
          <div className={`${theme === 'default' ? 'bg-white' : 'bg-gradient-to-r'} ${theme === 'default' ? '' : theme === 'ben10' ? 'from-[#64cc4f] to-[#222222] via-[#64cc4f]' : theme === 'tinkerbell' ? 'from-yellow-300 via-green-400 to-yellow-400' : theme === 'cricketverse' ? 'from-blue-400 via-indigo-500 to-blue-500' : theme === 'bounceworld' ? 'from-[#1D428A] to-[#C8102E] via-[#1D428A]' : theme === 'avengers' ? 'from-[#604AC7] via-[#2C1267] to-[#0F0826]' : theme === 'ponyville' ? 'from-[#f1aed5] via-[#e13690] to-[#ff2e9f]' : 'from-blue-400 via-indigo-500 to-blue-500'} rounded-3xl shadow-2xl border-4 border-black p-8 mt-8`}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="bg-white border-4 border-black rounded-2xl p-6 text-center shadow-lg hover:scale-105 transition-all">
                ...
                <div className={`text-3xl font-black mb-1 ${theme === 'default' ? 'text-blue-600' : theme === 'ben10' ? 'text-[#64cc4f]' : theme === 'tinkerbell' ? 'text-yellow-600' : theme === 'cricketverse' ? 'text-[#3b82f6]' : theme === 'bounceworld' ? 'text-[#C8102E]' : theme === 'avengers' ? 'text-[#604AC7]' : theme === 'ponyville' ? 'text-[#f1aed5]' : 'text-[#3b82f6]'}`}>
              ...
              <div className="bg-white border-4 border-black rounded-2xl p-6 text-center shadow-lg hover:scale-105 transition-all">
                <div className="text-4xl mb-2">🏆</div>
                <div className={`text-3xl font-black mb-1 ${theme === 'default' ? 'text-blue-600' : theme === 'ben10' ? 'text-[#64cc4f]' : theme === 'tinkerbell' ? 'text-yellow-600' : theme === 'cricketverse' ? 'text-[#3b82f6]' : theme === 'bounceworld' ? 'text-[#C8102E]' : theme === 'avengers' ? 'text-[#0F0826]' : theme === 'ponyville' ? 'text-[#e13690]' : 'text-[#3b82f6]'}`}>
              ...
              <div className="bg-white border-4 border-black rounded-2xl p-6 text-center shadow-lg hover:scale-105 transition-all">
                <div className="text-4xl mb-2">📈</div>
                <div className={`text-3xl font-black mb-1 ${theme === 'default' ? 'text-blue-600' : theme === 'ben10' ? 'text-[#64cc4f]' : theme === 'tinkerbell' ? 'text-yellow-600' : theme === 'cricketverse' ? 'text-[#3b82f6]' : theme === 'bounceworld' ? 'text-[#C8102E]' : theme === 'avengers' ? 'text-[#C88DA5]' : theme === 'ponyville' ? 'text-[#ff2e9f]' : 'text-[#3b82f6]'}`}>
