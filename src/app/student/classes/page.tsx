...
export default function StudentClassesPage() {
            ...
            {theme === 'cricketverse-australian' && (
              <div className="flex flex-col items-center">
                <img
                  ...
                  className="w-32 h-32 object-contain"
                />
                <span className="text-2xl font-bold text-black mt-4">Loading Classes</span>
              </div>
            )}
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className={`bg-gradient-to-r ${theme === 'default' ? 'from-gray-100 to-gray-200' : theme === 'ben10' ? 'from-[#64cc4f] to-[#222222]' : theme === 'tinkerbell' ? 'from-green-300 via-green-500 to-yellow-400' : theme === 'cricketverse' ? 'from-blue-500 to-indigo-600' : theme === 'cricketverse-australian' ? 'from-[#fff800] via-[#fff800] to-[#fff800]' : theme === 'bounceworld' ? 'from-[#1D428A] via-white to-[#C8102E]' : theme === 'avengers' ? 'from-[#2C1267] via-[#604AC7] to-[#0F0826] border-[#2C1267]' : theme === 'ponyville' ? 'from-[#f1aed5] via-[#e13690] to-[#ff2e9f] border-[#f1aed5]' : 'from-blue-400 to-indigo-600'} rounded-3xl shadow-2xl border-4 ${theme === 'bounceworld' ? 'border-[#1D428A]' : 'border-black'} p-8 mb-6 relative overflow-hidden`}>
        ...
        <div className={`${theme === 'default' ? 'bg-white' : 'bg-gradient-to-r'} ${theme === 'default' ? '' : theme === 'ben10' ? 'from-[#64cc4f] to-[#222222]' : theme === 'tinkerbell' ? 'from-green-300 via-green-400 to-yellow-400' : theme === 'cricketverse' ? 'from-blue-300 via-indigo-400 to-indigo-500' : theme === 'cricketverse-australian' ? 'from-[#fff800] via-[#fff800] to-[#fff800]' : theme === 'bounceworld' ? 'from-white via-[#1D428A]/20 to-white border-[#1D428A]' : theme === 'avengers' ? 'from-[#604AC7]/20 via-[#2C1267]/20 to-[#0F0826]/20 border-[#2C1267]' : theme === 'ponyville' ? 'from-[#f1aed5]/20 via-[#e13690]/20 to-[#ff2e9f]/20 border-[#f1aed5]' : 'from-blue-300 via-indigo-400 to-indigo-500'} rounded-2xl shadow-xl border-4 ${theme === 'bounceworld' ? 'border-[#1D428A]' : 'border-black'} p-6 mb-6`}>
        ...
        {filteredEnrollments.length === 0 ? (
          <div className={`${theme === 'default' ? 'bg-white' : 'bg-gradient-to-r'} ${theme === 'default' ? '' : theme === 'ben10' ? 'from-[#b2e05b] via-[#222222] to-[#64cc4f]' : theme === 'tinkerbell' ? 'from-yellow-200 via-green-400 to-yellow-300' : theme === 'cricketverse' ? 'from-blue-300 via-indigo-400 to-blue-400' : theme === 'cricketverse-australian' ? 'from-[#fff800] via-[#fff800] to-[#fff800]' : theme === 'bounceworld' ? 'from-white via-[#1D428A]/20 to-white border-[#1D428A]' : theme === 'avengers' ? 'from-[#604AC7]/30 via-[#2C1267]/30 to-[#0F0826]/30 border-[#2C1267]' : theme === 'ponyville' ? 'from-[#f1aed5]/30 via-[#e13690]/30 to-[#ff2e9f]/30 border-[#f1aed5]' : 'from-blue-300 via-indigo-400 to-blue-400'} rounded-3xl shadow-2xl border-4 border-black p-12`}>
            <div className="text-center">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {filteredEnrollments.map((enrollment) => (
              <div
                key={enrollment.id}
                className={`rounded-3xl shadow-2xl border-4 border-black p-6 hover:shadow-3xl hover:scale-105 transition-all duration-300 hover:rotate-1 ${theme === 'default' ? 'bg-white' : theme === 'ben10' ? 'bg-gradient-to-br from-[#b2e05b] via-[#222222] to-[#64cc4f]' : theme === 'tinkerbell' ? 'bg-gradient-to-br from-yellow-200 via-green-400 to-yellow-300' : theme === 'cricketverse' ? 'bg-gradient-to-br from-blue-300 via-indigo-400 to-blue-400' : theme === 'cricketverse-australian' ? 'bg-gradient-to-br from-[#fff800] via-[#fff800] to-[#fff800]' : theme === 'bounceworld' ? 'bg-gradient-to-br from-white via-[#1D428A]/20 to-white' : theme === 'avengers' ? 'bg-gradient-to-br from-[#604AC7] via-[#2C1267] to-[#0F0826]' : theme === 'ponyville' ? 'bg-gradient-to-br from-[#f1aed5] via-[#e13690] to-[#ff2e9f]' : 'bg-gradient-to-br from-blue-300 via-indigo-400 to-blue-400'}`}
              >
                {/* Class Header */}
        ...
        {/* Summary Stats */}
        {filteredEnrollments.length > 0 && (
          <div className={`${theme === 'default' ? 'bg-white' : 'bg-gradient-to-r'} ${theme === 'default' ? '' : theme === 'ben10' ? 'from-[#64cc4f] to-[#222222] via-[#64cc4f]' : theme === 'tinkerbell' ? 'from-yellow-300 via-green-400 to-yellow-400' : theme === 'cricketverse' ? 'from-blue-400 via-indigo-500 to-blue-500' : theme === 'cricketverse-australian' ? 'from-[#fff800] via-[#fff800] to-[#fff800]' : theme === 'bounceworld' ? 'from-[#1D428A] to-[#C8102E] via-[#1D428A]' : theme === 'avengers' ? 'from-[#604AC7] via-[#2C1267] to-[#0F0826]' : theme === 'ponyville' ? 'from-[#f1aed5] via-[#e13690] to-[#ff2e9f]' : 'from-blue-400 via-indigo-500 to-blue-500'} rounded-3xl shadow-2xl border-4 border-black p-8 mt-8`}>
