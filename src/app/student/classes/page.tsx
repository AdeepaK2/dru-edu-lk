...
export default function StudentClassesPage() {
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className={`bg-gradient-to-r ${theme === 'default' ? 'from-gray-100 to-gray-200' : theme === 'ben10' ? 'from-[#64cc4f] to-[#6aaa5a]' : theme === 'tinkerbell' ? 'from-green-300 via-green-500 to-yellow-400' : theme === 'cricketverse' ? 'from-blue-500 to-indigo-600' : theme === 'cricketverse-australian' ? 'bg-gradient-to-br from-[#f9f9bb] via-[#f6f672] to-[#ffff2a]' : theme === 'bounceworld' ? 'from-[#1D428A] via-white to-[#C8102E]' : theme === 'avengers' ? 'from-[#2C1267] via-[#604AC7] to-[#604AC7] border-[#2C1267]' : theme === 'ponyville' ? 'from-[#f1aed5] via-[#e13690] to-[#ff2e9f] border-[#f1aed5]' : 'from-blue-400 to-indigo-600'} rounded-3xl shadow-2xl border-4 ${theme === 'bounceworld' ? 'border-[#1D428A]' : 'border-black'} p-8 mb-6 relative overflow-hidden`}>
        ...
        {filteredEnrollments.length === 0 ? (
          <div className={`${theme === 'default' ? 'bg-white' : 'bg-gradient-to-r'} ${theme === 'default' ? '' : theme === 'ben10' ? 'from-[#b2e05b] via-[#69f05d] to-[#64cc4f]' : theme === 'tinkerbell' ? 'from-yellow-200 via-green-400 to-yellow-300' : theme === 'cricketverse' ? 'from-blue-300 via-indigo-400 to-blue-400' : theme === 'cricketverse-australian' ? 'from-white via-white to-white' : theme === 'bounceworld' ? 'from-white via-[#1D428A]/20 to-white border-[#1D428A]' : theme === 'avengers' ? 'from-[#604AC7]/30 via-[#2C1267]/30 to-[#0F0826]/30 border-[#2C1267]' : theme === 'ponyville' ? 'from-[#f1aed5]/30 via-[#e13690]/30 to-[#ff2e9f]/30 border-[#f1aed5]' : 'from-blue-300 via-indigo-400 to-blue-400'} rounded-3xl shadow-2xl border-4 border-black p-12`}>
            <div className="text-center">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {filteredEnrollments.map((enrollment) => (
              <div
                key={enrollment.id}
                className={`rounded-3xl shadow-2xl border-4 border-black p-6 hover:shadow-3xl hover:scale-105 transition-all duration-300 hover:rotate-1 ${theme === 'default' ? 'bg-white' : theme === 'ben10' ? 'bg-gradient-to-br from-[#b2e05b] via-[#65f263] to-[#64cc4f]' : theme === 'tinkerbell' ? 'bg-gradient-to-br from-yellow-200 via-green-400 to-yellow-300' : theme === 'cricketverse' ? 'bg-gradient-to-br from-blue-300 via-indigo-400 to-blue-400' : theme === 'cricketverse-australian' ? 'bg-gradient-to-br from-white via-white to-white' : theme === 'bounceworld' ? 'bg-gradient-to-br from-white via-[#1D428A]/20 to-white' : theme === 'avengers' ? 'bg-gradient-to-br from-[#604AC7] via-[#2C1267] to-[#0F0826]' : theme === 'ponyville' ? 'bg-gradient-to-br from-[#f1aed5] via-[#e13690] to-[#ff2e9f]' : 'bg-gradient-to-br from-blue-300 via-indigo-400 to-blue-400'}`}
              >
                {/* Class Header */}
