...
export default function StudentSheetsPage() {
  ...
  return (
    <div key={`sheets-${theme}`} className={`min-h-screen bg-gradient-to-br ${theme === 'ben10' ? 'from-[#64cc4f] via-[#b2e05b] to-[#222222]' : theme === 'tinkerbell' ? 'from-green-400 via-green-500 to-yellow-600' : 'from-blue-600 via-indigo-400 to-blue-500'} p-6`}>
      <div className="max-w-4xl mx-auto">
        {/* Theme-aware Header */}
        <div className={`bg-gradient-to-r ${theme === 'ben10' ? 'from-[#64cc4f] to-[#222222]' : theme === 'tinkerbell' ? 'from-green-400 via-green-500 to-yellow-600' : 'from-blue-400 to-blue-500'} rounded-3xl shadow-2xl border-4 border-black p-8 mb-8 relative overflow-hidden`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className={`bg-gradient-to-r ${theme === 'ben10' ? 'from-[#64cc4f] to-[#b2e05b]' : theme === 'tinkerbell' ? 'from-green-400 to-yellow-500' : 'from-blue-400 to-indigo-600'} rounded-3xl shadow-2xl border-4 border-black p-6`}>
          ...
          <div className={`bg-gradient-to-r ${theme === 'ben10' ? 'from-[#64cc4f] to-[#b2e05b]' : theme === 'tinkerbell' ? 'from-green-400 to-yellow-600' : 'from-blue-400 to-indigo-600'} rounded-3xl shadow-2xl border-4 border-black p-6`}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-2xl font-black text-black">
                  Active Classes
        ...
        <div className="bg-white rounded-3xl shadow-2xl border-4 border-black overflow-hidden">
          <div className={`bg-gradient-to-r ${theme === 'ben10' ? 'from-[#48a735]  to-[#222222]' : theme === 'tinkerbell' ? 'from-green-400 via-green-500 to-yellow-600' : 'from-blue-400 via-blue-500 to-blue-600'} p-6 border-b-4 border-black`}>
          ...
          {classes.length === 0 ? (
            <div className={`bg-gradient-to-r ${theme === 'ben10' ? 'from-[#222222] via-[#64cc4f] to-[#b2e05b]' : theme === 'tinkerbell' ? 'from-green-400 via-green-500 to-yellow-600' : 'from-blue-400 via-indigo-500 to-blue-600'} p-12 text-center border-t-4 border-black`}>
            ...
            <div className="divide-y-4 divide-black">
              {classes.map((classData) => (
                <div
                  key={classData.id}
                  className={`bg-gradient-to-r ${theme === 'ben10' ? 'from-[#64cc4f]  to-[#222222]' : theme === 'tinkerbell' ? 'from-green-400 via-green-500 to-yellow-600': 'from-blue-400 to-blue-600'} p-6 hover:scale-105 transition-all cursor-pointer border-b-4 border-black last:border-b-0`}
